    ...
    def _train(self, criterion, optimizer):
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            for i_batch, sample_batched in enumerate(self.train_data_loader):
                ...
                targets = sample_batched['negative'].to(self.opt.device)
    ...
    def _evaluate_acc_f1(self):
        ...
        with torch.no_grad():
            for t_batch, t_sample_batched in enumerate(self.val_data_loader):
                ...
                t_targets = t_sample_batched['negative'].to(opt.device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='finance', type=str, help='finance')
